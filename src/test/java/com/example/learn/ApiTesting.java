...
import com.example.learn.controller.MyController;
...
public class ApiTesting {
    ...
    public void testAddEmployee(){
        ...
        Assert.assertEquals(employee, myController.addEmployee(employee));
    }
    ...
    public void testFindByDepartment(){
        ...
        Assert.assertEquals(employee,myController.getEmployeeByDepartment(employee.getDepartment()));
        return;
    }
    ...
    public void testFindByAge(){
        ...
        Assert.assertEquals(employee,myController.getEmployeeByAge(employee.getAge()));
        return;
    }
